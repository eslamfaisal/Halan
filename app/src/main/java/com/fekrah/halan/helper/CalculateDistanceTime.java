...
public class CalculateDistanceTime {
    ...
    public void getDirectionsUrl(LatLng origin, LatLng dest,String k) {
        ...
        String uri2 = "https://maps.googleapis.com/maps/api/directions/json?origin=" + origin.latitude +
                "," + origin.longitude + "&destination=" + dest.latitude
                + "," + dest.longitude + "&key="+k;

        DownloadTask downloadTask = new DownloadTask();

        // Start downloading json data from Google Directions API

        downloadTask.execute(uri2);
    }
